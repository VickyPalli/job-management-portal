...
import DoubleRangeSlider from "./MultiRangeSlider";

export const Interactions = () => {
  return (
    <div className="w-full flex h-full py-6">
      <div className="w-[25%] h-full flex border-r-2 border-gray-300 px-4">
        ...
        >
          ...
          <input
            ...
            className="w-full outline-none cursor-pointer placeholder-gray-400 h-12 pl-16 pr-4 rounded-lg  "
          />
        </div>
      </div>

      <div className="w-[25%] h-full flex items-center border-r-2 border-gray-300 px-8">
        <svg
          width="18"
          height="23"
          viewBox="0 0 18 23"
        ...
        <div className="relative w-full">
          <select className="w-full h-12 pl-10 text-gray-400 pr-4 rounded-lg outline-none cursor-pointer  border-gray-300 :outline-none  appearance-none">
            <option className="text-gray-400">Preferred Location</option>
      ...
      <div className="w-[25%] h-full border-r-2 border-gray-300 px-4">
        <div className="relative w-[90%] flex items-center ml-8">
          <svg
            width="20"
            height="18"
            viewBox="0 0 20 18"
          ...
          <select className="w-full h-12 pl-10 pr-4 outline-none cursor-pointer  text-gray-400 rounded-lg border-gray-300 appearance-none">
      ...
      <div className="w-[25%] h-full px-4">
        <div className="w-full">
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Salary Per Month: ₹50K - ₹80K
          </label>
